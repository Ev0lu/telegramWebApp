...
import s from './WorkerUploadPhoto.module.css';
import plusSvg from '../../assets/plus2.svg';
import pencilSvg from '../../assets/pencil.svg';
import loader from '../../assets/loading.svg';
import { useState, useEffect } from 'react';

function WorkerUploadPhoto(props) {
  ...
  return (
    <div className={s.avatarForm} style={props.colorB === "light" ? {backgroundColor: "white"} : {backgroundColor: "#232323"} }>
      <div className={s.avatarForm_wrapper}>
        <h1 className={s.avatarForm_text} style={props.colorB === 'light' ? {color: 'black'} : {color: 'white'} }>Регистрация</h1>
        ...
        { avatar !== null &&
        <Link to={avatar !== null ? '/success_r' : '/worker_photo_registration'}>
          <button onClick={() => {
          validateFields()
          uploadPhoto()
...
export default WorkerUploadPhoto;
