...
import s from "./WorkerPersonalInfoForm.module.css"
import { Link } from "react-router-dom";
import arrowsvg from '../assets/arrow.svg'
import blackarr from '../assets/black.svg'


function WorkerPersonalInfoForm(props) {
...
//Getting info about user if that user already exists
    ...
    return (
        <div className={s.personalInfo} style={props.colorB==="light" ? {backgroundColor:"white"} : {backgroundColor:"#232323"} }> 
            <div className={s.personalInfo_wrapper}>
                ...
                <Link to={gender === '' || name === '' || lastName === '' || isExist === true || isExist === null ? '/worker_registration' : '/worker_location_registration'}>
  ...
  export default WorkerPersonalInfoForm;
